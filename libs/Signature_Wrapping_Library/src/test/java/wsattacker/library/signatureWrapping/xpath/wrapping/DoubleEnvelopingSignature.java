...
//		org.apache.log4j.Logger.getLogger("wsattacker.plugin.signatureWrapping.schema.SchemaAnalyser").setLevel(org.apache.log4j.Level.ALL);
        ...
        ks.load(new FileInputStream(kift.getKeyStoreFileName()), kift.getKeyStorePassword().toCharArray());
    }

    @Test
    public void testDoubleEnvSig() throws Exception {
...
//		System.out.println(String.format("%s\n\n%s", WeaknessLog.representation(), DomUtilities.domToString(attackDocument, true)));
