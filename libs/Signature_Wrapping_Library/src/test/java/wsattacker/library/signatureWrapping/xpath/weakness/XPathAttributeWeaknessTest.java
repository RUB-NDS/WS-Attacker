...
public class XPathAttributeWeaknessTest
{
        ...
        throws Exception
    {
        ...
        XPathAttributeWeakness aw =
            new XPathAttributeWeakness( step, new SignedElement( signed, null ), new PayloadElement( payload, null ) );
    ...
    @Test
    public void simpleTestAttributeInMiddle()
        throws Exception
    {
        String orgContent = "ORIGINAL CONTENT";
        String atkContent = "ATTACKER CONTENT";
        ...
        String xpath =
            DomUtilities.getFastXPath( soap.getDummyPayloadBody() ).replaceAll( "\\[1\\]", "" ) + "[@wsu:Id='" + id
                + "']/" + signed.getNodeName();
        AbsoluteLocationPath abs = new AbsoluteLocationPath( xpath );
        Step step = abs.getRelativeLocationPaths().get( 2 );
        XPathAttributeWeakness aw =
