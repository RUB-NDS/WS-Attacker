...
// NamespaceConstants.PREFIX_NS_WSATTACKER+"payloadBody");
        ...
        XPathDescendantWeakness xpw = new XPathDescendantWeakness(abs.getRelativeLocationPaths().get(1), new SignedElement(signedElement, null), new PayloadElement(payloadElement, null), sa);
...
// String fastXPathSignedPre = DomUtilities.getFastXPath(signedElement);
        ...
        // 1) Build the XPathDescendantWeakness
        AbsoluteLocationPath abs = new AbsoluteLocationPath(xpath);
        XPathDescendantWeakness xpw = new XPathDescendantWeakness(abs.getRelativeLocationPaths().get(0), new SignedElement(signedElement, null), new PayloadElement(payloadElement, null), sa);
...
// NamespaceConstants.PREFIX_NS_WSATTACKER+"payloadBody");
            ...
            XPathDescendantWeakness xpw = new XPathDescendantWeakness(descendantStep, new SignedElement(signedElement, null), new PayloadElement(payloadElement, null), sa);
...
// for attr
    ...
    public void withPreXPath() throws Exception {
        ...
        XPathDescendantWeakness weakness = new XPathDescendantWeakness(abs.getRelativeLocationPaths().get(3), new SignedElement(option.getSignedElement(), option.getReferringElement().getElementNode()), new PayloadElement(option.getPayloadElement(), option.getReferringElement().getElementNode()), sa);
...
//    System.out.println(weakness.getNumberOfPossibilities());
        ...
        weakness = new XPathDescendantWeakness(abs.getRelativeLocationPaths().get(1), new SignedElement(option.getSignedElement(), option.getReferringElement().getElementNode()), new PayloadElement(option.getPayloadElement(), option.getReferringElement().getElementNode()), sa);
        assertTrue(weakness.getNumberOfPossibilities() > 0);
    ...
    @Test
    public void signedRootElementByID() throws Exception {
        SoapTestDocument soap = new SoapTestDocument();
        ...
        System.out.println(DomUtilities.domToString(soap.getDocument(), true));
