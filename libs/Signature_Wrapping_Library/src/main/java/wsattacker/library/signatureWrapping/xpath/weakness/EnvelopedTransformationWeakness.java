...
//		List<Element> signatureElementList = DomUtilities.findChildren(signedElement.getSignedElement(), "Signature", NamespaceConstants.URI_NS_DS, true);
...
//			}
            ...
            while (tmp.getParentNode() != null) {
                if (tmp.getLocalName().equals("Signature") && tmp.getNamespaceURI().equals(NamespaceConstants.URI_NS_DS)) {
