...
public class SchemaAnalyzerFactory {
    ...
    /**
     * Creates a SchemaAnalyzer with NO Schemas contained.
     * This is NOT THE SAME as creating a NullSchemaAnalyzer.
     * However, this is equal to getInstance(EMPTY)
     *
     * @return
     */
    public static SchemaAnalyzerInterface getInstance() {
        return new SchemaAnalyzerNG();
    }

    /**
     * Creates a SchemaAnalyzer with predefined Schemas.
     ...
     * @return
     */
    public static SchemaAnalyzerInterface getInstance(String IDENTIFIER) {
        SchemaAnalyzerInterface schemaAnalyzer = null;
    ...
    private static void addSchemasToAnalyzer(SchemaAnalyzerInterface schemaAnalyzer, String[] schemaFiles) {
