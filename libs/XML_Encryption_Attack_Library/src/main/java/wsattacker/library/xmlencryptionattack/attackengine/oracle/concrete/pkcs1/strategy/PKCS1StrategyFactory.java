 ...
 * @author Dennis
 */
public class PKCS1StrategyFactory
{
    ...
    public static AbstractPKCS1Strategy createPKCS1Strategy( final PKCS1Strategy strategyType, final PKCS1Oracle oracle )
    {
        switch ( strategyType )
        {
            case DIRECT:
            ...
            case NO_KEYREF:
                return new NoEncryptedKeyRefStrategy( oracle );
            default:
