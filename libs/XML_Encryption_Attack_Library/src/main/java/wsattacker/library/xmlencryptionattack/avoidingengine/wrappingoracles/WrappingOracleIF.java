...
public interface WrappingOracleIF
{
    Document getPossibility( int index )
        throws InvalidWeaknessException;

    int maxPossibilities();

    void addAdditionalEncryptionWeakness( AbstractEncryptionWeakness addWeak );
}
