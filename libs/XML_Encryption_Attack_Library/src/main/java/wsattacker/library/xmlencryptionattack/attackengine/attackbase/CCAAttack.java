 ...
 */
public abstract class CCAAttack
    extends XMLEncryptionAttackBase
{
    protected AOracle m_Oracle = null;

    public AOracle getOracle()
    {
        return m_Oracle;
    }

    public void setOracle( AOracle oracle )
    {
