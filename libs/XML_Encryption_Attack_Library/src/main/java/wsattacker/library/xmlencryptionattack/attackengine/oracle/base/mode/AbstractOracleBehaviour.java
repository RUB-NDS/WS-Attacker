 ...
 * @author Dennis
 */
public abstract class AbstractOracleBehaviour
{
    protected OracleResponseCollector m_ErrorResponseTab = null;

    public abstract OracleResponse compareServerRespWithUserClassification( OracleResponse resp,
                                                                            AbstractEncryptionElement pay );
}
