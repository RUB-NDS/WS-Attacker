...
public class CertificateHandler {
    ...
    public CertificateHandler(final String cert) throws
    ...
    public void createFakedCertificate() throws CertificateHandlerException {
        try {
            ...
            KeyPairGenerator kpg = KeyPairGenerator.getInstance(
              originalPublicKey.getAlgorithm());
            kpg.initialize(((RSAPublicKey) certificate.getPublicKey()).
            ...
            // TODO: new SecureRandom().generateSeed(64) is very slow! Replace it?
//            BigInteger sn = new BigInteger(new SecureRandom().generateSeed(64));
            ...
            info.set(X509CertInfo.KEY, new CertificateX509Key(
              fakedKeyPair.getPublic()));

            info.set(X509CertInfo.VERSION, new CertificateVersion(CertificateVersion.V3));

            AlgorithmId algo = new AlgorithmId(new ObjectIdentifier(
    ...
    public String getFakedCertificateString() throws
      CertificateHandlerException {
        try {
