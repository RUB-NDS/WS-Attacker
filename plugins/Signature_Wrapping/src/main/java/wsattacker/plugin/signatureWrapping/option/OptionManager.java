 ...
 */
public class OptionManager implements CurrentRequestContentChangeObserver, PropertyChangeListener {
    ...
    private OptionManager() {
        ...
        optionMustContainString.addPropertyChangeListener(OptionSimpleBoolean.PROP_ON, this);
        optionSchemaFiles.addPropertyChangeListener(AbstractOptionMultiFiles.PROP_FILES, this);
        optionNoSchema.addPropertyChangeListener(OptionSimpleBoolean.PROP_ON, this);
    }
