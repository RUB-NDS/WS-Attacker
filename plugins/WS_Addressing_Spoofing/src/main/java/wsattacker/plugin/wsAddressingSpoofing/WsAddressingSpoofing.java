...
public class WsAddressingSpoofing extends AbstractPlugin {
    ...
    private static final String DESCRIPTION = "This attack plugin checks if the server is vulnerable to WS-Addressing Spoofing.\n"
    ...
    public void initializePlugin() {
        ...
        localServerUrl = new OptionSimpleVarchar("Endpoint",
          "http://localhost:10080", // will be automatically overwritten
