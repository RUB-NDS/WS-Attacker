...
public class HashCollisionDJBX33A
    extends AbstractDosPlugin
{
    ...
    {
        setName( "DJBX33A Hash Collision Attack" );
        setDescription( "<html><p>This attack checks wheter or not a Web service is vulnerable to a "
            + "Hash Collision Attack for a DJBX33A hash algorithm.</p>"
            + "<p>The attack exhausts the resources of the server by constantly creating collisions "
            + "in the hash map algorithm that is used to process the XML document. "
            + "See the original advisory: <a href=\"http://www.nruns.com/_downloads/advisory28122011.pdf\">http://www.nruns.com/_downloads/advisory28122011.pdf</a></p>"
            + "<p>The attack algorithm replaces the string $$PAYLOADATTR$$ in the SOAP message below "
            + "with the defined number of colliding attributes or XML namespaces. </p>"
    ...
    public void createTamperedRequest()
    {
        ...
        // DJBX33A - n viele Kollisionen erzeugen
        CollisionDJBX33A DJBX33A = new CollisionDJBX33A();
        DJBX33A.genNCollisions( optionNumberAttributes.getValue(), sb, optionUseNamespaces.isOn() );
    ...
    public void createUntamperedRequest()
    {
        ...
        CollisionDJBX33A DJBX33A = new CollisionDJBX33A();
        String untampered =
            UtilHashDoS.generateUntampered( DJBX33A, optionNumberAttributes.getValue(), optionUseNamespaces.isOn() );
