...
public class CollisionDJBX31A implements CollisionInterface {   
	...
	int hash = 0;
	for (int i = 0; i < n; i++) {
	    //System.out.println(i +" out of "+n+" mit Byte: "+(int)byteArray[i]+" und Hash preCalc: "+ ((hash<<5)-hash));
    ...
    /*
     * get i-th ternaryCollisionString out of 3^n possible ternaryCollisionStrings since
     ...
     *
     * How does it work for n = 2 -> 3^2 = 9 possible strings?
     ...
     * row8: 22
     * 
     * for i = 4 -> 4th row is picked and created!
     * 
