...
public class ChartObject
{
    ...
    public JFreeChart createOverlaidChart()
    {
        ...
        final NumberAxis xAxis1 =
            new NumberAxis( "Number Requests Per Interval (" + ( model.getIntervalLengthReport() / 1000 ) + " sec)" );
    ...
    /*
     * Creates Dataset Response Time for following types: - tampered - untampered - testprobe
