...
import static wsattacker.plugin.dos.dosExtension.abstractPlugin.AbstractDosPlugin.*;
...
public class AttackModel implements AttackModelSubject // implements Oberserver (DesignPatterns Seite 52)
{
     ...
     * Called via InvokeLater-runnable in different Threads -> thats why not
     * syncronized!
     * CALLED IN EDT:
     ...
     * it has a major influence on how many datapoints are shown in result
     * graph!
     */
     ...
     * <ul>
     * <li>Result = 1: <br />No difference between tampered and untampered
     * requests</li>
     * <li>Result &lt; 1: <br />response time of tampered Requests is even lower
     * than the response time of untampered requests -> attack not successful!
     * </li>
     * <li>Result &gt; 1: <br />response time of tampered Requests are higher
     * than response time of untampered requests. In this case the attack is
     * successful!
     * The attack can be considered as a success when the result is higher than
     * 2 points </li>
     * </ul>
     *
     * Defined as:
    ...
    /*
     * Calculate Attack effectivness 2 - attack efficiency (size) under given
     * load scenario.
     * Sets requestSizeTampered and requestSizeUntampered in relation
     * The results should be interpreted as follows:
     * <ul>
     * <li>Result = 1: <br />Size of attack request is equal to the size of
     * untampered attack
     * <li>Result &lt; 1: <br />size of untampered request is lower than the
     * size of tampered request.
     * <li>Result &gt; 1: <br />size of untampered request is higher than the
     * size of tampered request.
     * </ul>
     ...
     * REMEMBER: first 6 entries are reserved for standard DOS attack
     * parameters..
     * @return
     */
