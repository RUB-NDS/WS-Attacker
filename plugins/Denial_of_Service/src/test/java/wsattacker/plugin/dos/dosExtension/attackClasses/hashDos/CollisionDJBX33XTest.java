...
public class CollisionDJBX33XTest {
    ...
    /**
     * Test HashBack and HashForth for random String at same time!
     * Loads string from predefined lookuptable under target "0"
     */
    @Test
	...
	try {
	    ...
	    System.out.println(" - "+preGeneratedCollisionString.substring(7, 10)+" -- "+preGeneratedCollisionString.substring(0, 7));
