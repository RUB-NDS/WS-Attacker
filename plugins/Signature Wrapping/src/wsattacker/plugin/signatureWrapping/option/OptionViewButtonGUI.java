/*
 * WS-Attacker - A Modular Web Services Penetration Testing Framework Copyright (C) 2010 Christian Mainka
 * 
 ...
 */
public class OptionViewButtonGUI extends AbstractOptionGUI
{
  ...
  public OptionViewButtonGUI(ControllerInterface controller,
                             AbstractPlugin plugin,
                             OptionViewButton option)
  {
    ...
    thisLayout.setHorizontalGroup(thisLayout.createSequentialGroup()
      ...
      .addGroup(thisLayout.createParallelGroup()
          .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
              .addGap(174, 174, 174)
              .addComponent(viewButton, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
              .addGap(10))
          .addComponent(descriptionScrollPane, GroupLayout.Alignment.LEADING, 0, 254, Short.MAX_VALUE)
          .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
              .addComponent(description, 0, 242, Short.MAX_VALUE)
              .addGap(0, 12, GroupLayout.PREFERRED_SIZE))));
    thisLayout.setVerticalGroup(thisLayout.createParallelGroup()
      .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
          .addComponent(viewButton, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
          .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 14, GroupLayout.PREFERRED_SIZE)
          .addComponent(description, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
          .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
          .addComponent(descriptionScrollPane, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE))
      .addComponent(nameScrollPane, GroupLayout.Alignment.LEADING, 0, 85, Short.MAX_VALUE));
  ...
  public JDialog getViewDialog()
  {
    ...
    if (viewDialog == null)
    {
      ...
      GroupLayout viewDialogLayout = new GroupLayout((JComponent) viewDialog.getContentPane());
...
//        possibilitySwitcher.setMajorTickSpacing(10);
      ...
      viewDialogLayout.setHorizontalGroup(viewDialogLayout.createSequentialGroup()
        .addContainerGap()
        .addGroup(viewDialogLayout.createParallelGroup()
            .addGroup(GroupLayout.Alignment.LEADING, viewDialogLayout.createSequentialGroup()
                .addComponent(directChooser, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ofLabel, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
                .addComponent(getMaxPossibilitiesLabel(), GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(viewDialogLayout.createParallelGroup()
                    .addComponent(getLogLabel(), GroupLayout.Alignment.LEADING, 0, 555, Short.MAX_VALUE)
                    .addGroup(GroupLayout.Alignment.LEADING, viewDialogLayout.createSequentialGroup()
                        .addGap(0, 466, Short.MAX_VALUE)
                        .addComponent(getCloseButton(), GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE))))
            .addComponent(possibilitySwitcher, GroupLayout.Alignment.LEADING, 0, 716, Short.MAX_VALUE)
            .addComponent(headline, GroupLayout.Alignment.LEADING, 0, 716, Short.MAX_VALUE)
            .addComponent(getJScrollPane1(), GroupLayout.Alignment.LEADING, 0, 716, Short.MAX_VALUE))
        .addContainerGap());
      viewDialogLayout.setVerticalGroup(viewDialogLayout.createSequentialGroup()
        .addContainerGap()
        .addComponent(headline, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
        .addComponent(possibilitySwitcher, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE)
        .addGroup(viewDialogLayout.createParallelGroup()
            .addComponent(getLogLabel(), GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
            .addGroup(viewDialogLayout.createSequentialGroup()
                .addGap(12)
                .addGroup(viewDialogLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(directChooser, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(ofLabel, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(getMaxPossibilitiesLabel(), GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
                .addGap(30)))
        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
        .addComponent(getJScrollPane1(), 0, 391, Short.MAX_VALUE)
        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(getCloseButton(), GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
        .addContainerGap());
    }
    initView();
    return viewDialog;
  ...
  private void createWrappingOracle()
  {
    ...
    SchemaAnalyzerInterface sai = signateWrappingPlugin.getUsedSchemaAnalyser();
    wrappingOracle = new WrappingOracle(sm.getDocument(), sm.getPayloads(), sai);
  }
