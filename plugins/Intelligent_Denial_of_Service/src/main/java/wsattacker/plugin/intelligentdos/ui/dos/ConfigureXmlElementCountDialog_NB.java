...
import wsattacker.plugin.intelligentdos.ui.helper.XMLElementValidator;

/**
 * @author Christian Altmeier
 */
public class ConfigureXmlElementCountDialog_NB
    extends javax.swing.JDialog
{

    private transient final XmlElementCount xmlElementCount;
     ...
     * 
     * @param xmlElementCount
     */
    public ConfigureXmlElementCountDialog_NB( XmlElementCount xmlElementCount )
    {
        this.xmlElementCount = xmlElementCount;
        initComponents();

        // only xml element names allowed
        configureStringList_NB1.setValidator( new XMLElementValidator() );

        final IterateModel numberOfTagsIterator = xmlElementCount.getNumberOfElementsIterator();
        ...
        List<String> elements = Arrays.asList( xmlElementCount.getElements() );
    ...
    private void setElements()
    {
        ...
        xmlElementCount.setElements( elements );
    }
