...
import wsattacker.gui.component.target.subcomponent.NamespaceTable;
...
import wsattacker.gui.component.target.subcomponent.RequestInputTable;
import wsattacker.gui.component.target.subcomponent.WsdlInputField;
...
public class WsdlLoaderGUI extends javax.swing.JPanel {
	private final String firstURL = "http://127.0.0.1:8080/axis2/services/sample02?wsdl";
...
//				uri.setText("wsdl-files/prim.wsdl");
	...
	public RequestInputTable getRequestInputTable() {
		if(requestInputTable == null) {
			requestInputTable = new RequestInputTable();
		}
	...
	private RequestInputEditor getRequestInputEditor() {
		if(requestInputEditor == null) {
			requestInputEditor = new RequestInputEditor();
