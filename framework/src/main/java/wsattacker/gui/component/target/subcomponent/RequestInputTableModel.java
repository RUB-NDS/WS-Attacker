...
public class RequestInputTableModel extends AbstractTableModel implements CurrentRequestContentChangeObserver, CurrentRequestObserver {
    ...
    public void setController(ControllerInterface controller) {
        ...
        if (oldController != null) {
            this.controller.getTestSuite().getCurrentRequest().removeCurrentRequestContentObserver(this);
            this.controller.getTestSuite().getCurrentRequest().removeCurrentRequestObserver(this);
        }
