...
public class PluginConfigurationGUI_NB extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pluginConfigurationController = new wsattacker.gui.component.pluginconfiguration.controller.PluginConfigurationController();
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, pluginConfigurationController, org.jdesktop.beansbinding.ELProperty.create("${pluginManager}"), pluginTreeModel, org.jdesktop.beansbinding.BeanProperty.create("pluginManager"));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(splitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 618, Short.MAX_VALUE)
        );
    ...
    private void pluginTreeValueChanged1(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_pluginTreeValueChanged1
    ...
    private void pluginTreeValueChanged(it.cnr.imaa.essi.lablib.gui.checkboxtree.TreeCheckingEvent evt) {//GEN-FIRST:event_pluginTreeValueChanged
		...
		if (o instanceof AbstractPlugin) {
			pluginConfigurationController.getController().setPluginActive(((AbstractPlugin) o).getName(),
				...
				pluginTree.getModel().getRoot().getClass())) {
			Object node = pluginTree.getModel().getRoot();
			Object[] path = evt.getPath().getPath();
			for (int i = 1; i < path.length; ++i) {
				node = pluginTree.getModel().getChild(node,
						pluginTree.getModel().getIndexOfChild(node, path[i]));
			}
    ...
    private void pluginTreeTreeCollapsed(javax.swing.event.TreeExpansionEvent evt) {//GEN-FIRST:event_pluginTreeTreeCollapsed
		int pos = pluginTree.getPreferredSize().width + 5;
		splitPane.setDividerLocation(pos);
    }//GEN-LAST:event_pluginTreeTreeCollapsed

    private void pluginTreeTreeExpanded(javax.swing.event.TreeExpansionEvent evt) {//GEN-FIRST:event_pluginTreeTreeExpanded
		int pos = pluginTree.getPreferredSize().width + 5;
		splitPane.setDividerLocation(pos);
