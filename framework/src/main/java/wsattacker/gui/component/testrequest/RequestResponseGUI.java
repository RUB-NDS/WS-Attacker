 ...
 */
public class RequestResponseGUI extends javax.swing.JPanel implements PropertyChangeListener {
	...
	public RequestResponseGUI(ControllerInterface controller) {
		...
		initGUI();
		this.controller.getTestSuite().getCurrentRequest().addPropertyChangeListener(CurrentRequest.PROP_WSDLREQUEST, this);
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				{
					requestContent = new RequestInputEditor();
					requestContent.setController(controller);
